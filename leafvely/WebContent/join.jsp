...
<body>
	...
	<div class='boxA'>
		<div class='certification'>
			...
			<input type=radio id='mobile' name='name'> <label
				for='mobile'>휴대폰인증</label> <input type=radio id='ipin' name='name'>
	...
	<form action="join" method="post">
		<div class='boxB'>
				...
				<table>
					...
					<tr>
						...
						<td><input type='password' name="pwCheck" id='pwCheck'
							required></td>
						<td><span id='same'
							style='color: darkolivegreen; font-size: 12px; font-weight: bold;'>비밀번호가
								일치합니다.</span><span id='discord'
							style='font-size: 12px; font-weight: bold;'>비밀번호가
								일치하지않습니다.</span></td>
					</tr>
					...
					<tr>
						...
						<td><input type='text' class='normaltext' name="userName"
							required></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" id="sample6_postcode"
							placeholder="우편번호" name="postCode" readonly></td>
						<td><input type="button" id="sample6_execDaumPostcode"
							value="우편번호 찾기"></td>
					</tr>
					<tr>
					...
					<tr>
						<td><input type="text" id="sample6_detailAddress"
							placeholder="상세주소" name="addressDetail" required></td>
						<td><input type="text" id="sample6_extraAddress"
							placeholder="참고항목" name="addressExtra" readonly></td>
					</tr>
					<tr>
						<td>
							<p>
					...
					<tr>
						...
						<td colspan="2"><input type='radio' name='snsAg' id='agree1'
							required> <label for='agree1'>동의함</label> <input
							type='radio' name='snsAg' id='agree3'> <label
							for='agree3'>동의하지않음</label></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan='3'><input type='text' name="userEmail"
							id='email_1' required> <small>@</small> <input
							type='text' id='email_2' name="userEmail" required> <select
					...
					<tr>
						...
						<td colspan="2"><input type='radio' name='emailAg'
							id='agree2' required> <label for='agree2'>동의함</label> <input
							type='radio' name='emailAg' id='agree4'> <label
							for='agree4'>동의하지않음</label></td>
					</tr>
					<tr>
			...
			<div class='addinfo'>
				<strong>추가정보 | </strong> <small>선택사항</small>
				<table>
					<tr>
						<td>생년월일</td>
						<td><input type='text' class='smalltext' name="birthDate">
							...
							일</td>
						<td><input type='radio' name='name' id='Lift'> <label
							for='Lift'>앙력</label> <input type='radio' name='name' id='Lunar'>
...
06.“예치금”이란 쇼핑몰이 회원과의 거래에서 주문취소 등의 결제대금 환불, 초과입금 차액 환불등으로 발생한 금액을 현금대신 임시지급(적립)하여 현금과 동일하게 사용이 가능한 것을 말합니다.
				...
				<div class='agree_check'>
					<p>이용약관에 동의하십니까?</p>
					<input type='checkbox' name='name' id='agree_1' required> <label
...
04.전항의 경우 쇼핑몰은 이로 인하여 이용자가 입은 손해를 배상합니다. 다만, 쇼핑몰이 고의 또는 중대 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.
				...
				<div class='agree_check'>
					...
					<input type='checkbox' name='name' id='agree_2' required> <label
						for='agree_2'>동의함 (필수)</label>
				</div>
				<div class='agree_all'>
					<input type='checkbox' name='name' id='allagree'> <label
						for='allagree'>전체동의 하기</label>
				</div>
			</div>
		</div>
		<div class='boxE'>
			<div class='confirm'>
				...
				<input type='submit' name='submit' value='회원가입'> <input
					type='button' onclick="location.href='shoppingmall.jsp'" value='취소'>
			</div>
		</div>
	</form>
	...
	<div class='quick'>
		<a href="#"><i class="fas fa-chevron-up"></i></a> <a id='down'><i
