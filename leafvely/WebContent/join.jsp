...
<body>
    ...
    <div class='boxA'>
        <div class='certification'>
            <input type=radio id='card' name='name'>
            <label for='card'>신용카드인증</label>
            <input type=radio id='mobile' name='name'>
            <label for='mobile'>휴대폰인증</label>
            <input type=radio id='ipin' name='name'>
            ...
            <div class='infor'>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan='3'><small>(영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)</small></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><span id='same' style='color:darkolivegreen; font-size:12px; font-weight: bold;'>비밀번호가 일치합니다.</span><span id='discord' style='font-size:12px; font-weight: bold;'>비밀번호가 일치하지않습니다.</span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type='radio' name='snsAg' id='agree1' required>
                            <label for='agree1'>동의함</label>
                            <input type='radio' name='snsAg' id='agree3'>
                            <label for='agree3'>동의하지않음</label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan='3'>
                        <input type='text' name="userEmail" id='email_1' required>
                        <small>@</small>
                        <input type='text' id='email_2' name="userEmail" required>
                        <select id='emailSelect' name='emailSelect' style='vertical-align: bottom'>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type='radio' name='emailAg' id='agree2' required>
                            <label for='agree2'>동의함</label>
                            <input type='radio' name='emailAg' id='agree4'>
                            <label for='agree4'>동의하지않음</label>
                        </td>
                    </tr>
                    <tr>
...
06.“예치금”이란 쇼핑몰이 회원과의 거래에서 주문취소 등의 결제대금 환불, 초과입금 차액 환불등으로 발생한 금액을 현금대신 임시지급(적립)하여 현금과 동일하게 사용이 가능한 것을 말합니다.
                ...
                <div class='agree_check'>
                    <p>이용약관에 동의하십니까?</p>
                    <input type='checkbox' name='name' id='agree_1' required>
...
04.전항의 경우 쇼핑몰은 이로 인하여 이용자가 입은 손해를 배상합니다. 다만, 쇼핑몰이 고의 또는 중대 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.
                ...
                <div class='agree_check'>
                    ...
                    <input type='checkbox' name='name' id='agree_2' required>
        ...
        <div class='boxE'>
            <div class='confirm'>
                ...
                <input type='button' onclick="location.href='shoppingmall.jsp'" value='취소'>
            </div>
        </div>
    </form>
