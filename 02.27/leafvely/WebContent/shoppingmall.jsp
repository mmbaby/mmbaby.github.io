	...
	<div class='box1'>
		...
		<div class='box1_2'>
			<div class='loginStatus'>
				<p><c:if test="${sessionScope.id ne null}">${sessionScope.id} <span style="font-size: 12px; display: inline;">님 안녕하세요.</span></c:if></p>
			</div>
			<ul class='join'>
				<li><a href="login.html"><i class="fas fa-link"></i><span>LOGIN
							<small>OR</small> JOIN
					</span></a></li>
